...
constexpr std::array<u64, 8> file_masks = {
    ...
    FILE_A_MASK << 3,  // ...
    FILE_A_MASK << 4, FILE_A_MASK << 5, FILE_A_MASK << 6,
...
constexpr std::array<u64, 8> rank_masks = {
    ...
    RANK_1_MASK << 24,  // ...
    RANK_1_MASK << 32, RANK_1_MASK << 40, RANK_1_MASK << 48,
...
constexpr std::array<u64, 8> leftcum_file_masks = {
    ...
    file_masks[FILE_A] | file_masks[FILE_B] | file_masks[FILE_C] |
        file_masks[FILE_D],
    file_masks[FILE_A] | file_masks[FILE_B] | file_masks[FILE_C] |
        file_masks[FILE_D] | file_masks[FILE_E],
    file_masks[FILE_A] | file_masks[FILE_B] | file_masks[FILE_C] |
...
constexpr std::array<u64, 8> rightcum_file_masks = {
    ...
    file_masks[FILE_H] | file_masks[FILE_G] | file_masks[FILE_F] |
        file_masks[FILE_E],
    file_masks[FILE_H] | file_masks[FILE_G] | file_masks[FILE_F] |
        file_masks[FILE_E] | file_masks[FILE_D],
    file_masks[FILE_H] | file_masks[FILE_G] | file_masks[FILE_F] |
        file_masks[FILE_E] | file_masks[FILE_D] | file_masks[FILE_C],
    file_masks[FILE_H] | file_masks[FILE_G] | file_masks[FILE_F] |
        file_masks[FILE_E] | file_masks[FILE_D] | file_masks[FILE_C] |
        file_masks[FILE_B],
    file_masks[FILE_H] | file_masks[FILE_G] | file_masks[FILE_F] |
